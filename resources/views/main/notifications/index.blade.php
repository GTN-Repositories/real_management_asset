        ...
        <div class="container">
            <div class="card my-4">
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <span class="badge-notif bg-danger text-white text-center d-flex justify-content-center align-items-center">{{ count(\App\Helpers\Helper::notification()) }}</span>
                </div>
            </div>
            <div class="d-flex flex-column justify-content-center gap-4">
                ...
                <div class="card shadow" onclick="openModal('{{ $item->id }}')" style="border-radius: 10px; cursor: pointer;">
                    <div class="d-flex p-2 gap-5">
                        ...
                        <div class=" d-flex flex-column gap-2">
                            ...
                            <p class="m-0 massage">
                                ...
                                Hai [Nama Anda], ini adalah pengingat untuk mengisi draft sample dashboard. Apakah Anda sudah siap untuk mulai? (Ini Data Masih Dummy)
                                @endif
                            </p>
