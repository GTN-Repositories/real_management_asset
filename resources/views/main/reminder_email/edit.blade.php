...
<div class="text-center mb-4">
    <h3 class="role-title mb-2">Edit Reminder Email</h3>
    <p class="text-muted">Set Reminder Email</p>
</div>
<!-- Add User form -->
<form id="editDataForm" class="row g-3" method="POST" action="{{ route('reminder-email.update', $data->id) }}">
    @csrf
    @method('PUT')
