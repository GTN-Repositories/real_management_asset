...
<form id="EditPermissionForm" class="row" method="POST" action="{{ route('permision.store', Crypt::encryptString($data->id)) }}">
    @csrf
    <div class="col-12 mb-3">
        <label class="form-label" for="name">Permission Name</label>
        <input type="text" id="name" value="{{ $data->name }}" name="name" class="form-control" placeholder="Permission Name"
            autofocus />
    </div>
