...
@push('js')
    <script>
        ...
        function deleteData(element) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('permision.destroy', ':id') }}".replace(':id', id),
                        type: 'DELETE',
                        data: {
                            '_token': '{{ csrf_token() }}'
                        },
        ...
        function bulkDelete(ids) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                            url: "{{ route('permision.destroyAll') }}",
                            type: 'POST',
                            data: postForm,
                            dataType: 'json',
                        })
        ...
        function editData(elemen) {
            ...
            $.ajax({
                    url: "{{ route('permision.edit', ':id') }}".replace(':id', id),
                    type: 'GET',
                })
                .done(function(data) {
