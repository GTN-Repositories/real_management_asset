...
<form method="POST" class="row g-3" id="formEdit" action="{{ route('category-item.update', $data->id) }}" enctype="multipart/form-data">
    @csrf
    @method('put')
    ...
    <div class="col-12 col-md-12">
        ...
        <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Masukkan Deskripsi">{{ $data->description }}</textarea>
    </div>
