...
<div class="text-center mb-4">
    <h3 class="mb-2">Tambah Vendor</h3>
    <p class="text-muted">Tambahkan Data Sesuai Dengan Informasi Yang Tersedia</p>
</div>
<form method="POST" class="row g-3" id="formCreate" action="{{ route('vendor.store') }}" enctype="multipart/form-data">
    @csrf

    <div class="col-12 col-md-6">
        <label class="form-label">Nama Vendor</label>
        <input type="text" name="name" id="name" class="form-control mb-3 mb-lg-0"
            placeholder="Masukan Nama Vendor" value="{{ old('name') }}" required />
    </div>
    ...
    <div class="col-12 col-md-6">
        ...
        <input type="text" name="bank_account_name" id="bank_account_name" class="form-control mb-3 mb-lg-0"
            placeholder="Masukan A/N Bank" value="{{ old('bank_account_name') }}" required />
    </div>
