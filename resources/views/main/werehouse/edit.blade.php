...
<div class="text-center mb-4">
    <h3 class="mb-2">Edit Gudang</h3>
    <p class="text-muted">Edit Data Sesuai Dengan Informasi Yang Tersedia</p>
</div>
<form method="POST" class="row g-3" id="formEdit" action="{{ route('werehouse.update', $data->id) }}" enctype="multipart/form-data">
    @csrf
    @method('put')
