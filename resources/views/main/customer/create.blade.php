...
<form method="POST" class="row g-3" id="formCreate" action="{{ route('customer.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-12 col-md-6">
        ...
        <input type="text" id="alias" name="alias" class="form-control" placeholder="Masukkan Alias"/>
    </div>
    <div class="col-12 col-md-6">
        <label class="form-label" for="phone_number">No Telepon <span class="text-danger">*</span></label>
        <input type="text" id="phone_number" name="phone_number" class="form-control" placeholder="Masukkan No Telepon"/>
    </div>
