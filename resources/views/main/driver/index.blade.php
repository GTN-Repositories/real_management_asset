...
@section('content')
    ...
    <section class="section-py first-section-pt">
        <div class="container">
            <h2 class="text-center my-4">Pricing Plans</h2>
                ...
                success: function(data) {
                    ...
                    <div class="col-md-4 mb-md-0 mb-4">
                        <div class="card border rounded shadow-none" style="height: 30rem;">
                            <div class="card-body">
                                <div class="my-3 pt-2 text-center"></div>
                            ...
                            <div class="card-footer">
                                <button class="btn btn-label-success d-grid w-100 select-project-btn" data-manager-name="${manager.name}">Pilih Management Project</button>
                            </div>
                        </div>
                    </div>
                `);
