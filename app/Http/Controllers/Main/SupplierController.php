...
class SupplierController extends Controller
{
    ...
    public function getData(Request $request)
    {
        ...
        $data = Supplier::orderBy('created_at', 'asc')
            ->select($columns)
    ...
    {
        $data = Site::all();
        return view('main.supplier.create', compact('data'));
    }
    ...
    {
        $data = Supplier::findByEncryptedId($id);
        $site = Site::all();
        return view('main.supplier.edit', compact('data', 'site'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            return $this->atomic(function () use ($data, $id) {
                $data = Supplier::findByEncryptedId($id)->update($data);
    ...
    public function destroyAll(Request $request)
    {
        try {
            ...
            return $this->atomic(function () use ($ids) {
                ...
                $delete = Supplier::whereIn('id', $decryptedIds)->delete();
