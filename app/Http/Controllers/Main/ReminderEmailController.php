...
class ReminderEmailController extends Controller
{
    ...
    {
        return view('main.reminder_email.index');
    }
    ...
    public function getData(Request $request)
    {
        ...
        $data = GeneralSetting::orderBy('value', 'asc')
            ->where('group', 'email_reminder')
            ->select($columns)
    ...
    {
        return view('main.reminder_email.create');
    }
    ...
    {
        $data = GeneralSetting::findByEncryptedId($id);

        return view('main.reminder_email.edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            return $this->atomic(function () use ($data, $id) {
                $data = GeneralSetting::findByEncryptedId($id)->update([
                    'value' => $data['email'],
                ]);
    ...
    public function destroyAll(Request $request)
    {
        try {
            ...
            return $this->atomic(function () use ($ids) {
                ...
                $delete = GeneralSetting::whereIn('id', $decryptedIds)->delete();
